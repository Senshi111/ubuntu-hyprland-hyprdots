...
> **Note**
>
> thanks to prasanthrangan's work, I only took his themes and modified the scripts so that they could work in ubuntu devel branch
...
### for debian version you can go to my other github [here](https://github.com/Senshi111/debian-hyprland-hyprdots) 

## My Ubuntu Devel Hyprland Config
...
git clone https://github.com/Senshi111/ubuntu-hyprland-hyprdots.git
cd ~/debian-hyprland-hyprdots/build-and-install
./install_all.sh
```
